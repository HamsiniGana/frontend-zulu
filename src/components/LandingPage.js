    ...
    return (
      ...
      <div className="bg-light-green w-full m-[50px] rounded-3xl flex flex-col items-center ">
        <div className="flex flex-row justify-end my-5 mr-[50px] mb-[160px] gap-5 w-full ">
            <button className="bg-medium-green hover:bg-black hover:text-white text-black text-xl font-bold py-5 px-[40px] rounded-full"
          ...
          <button className="bg-dark-green hover:bg-black text-white font-bold text-xl py-5 px-[40px] rounded-full"
                  onClick={() => nav('/sign-up')}>
            Sign up
          </button>
        </div>
