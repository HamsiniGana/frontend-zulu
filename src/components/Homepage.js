    ...
    <div className="flex flex-col">
      ...
      <div className="bg-light-green min-h-screen flex flex-col">
        <div className="flex flex-row gap-[20vw] bg-gradient-to-r from-medium-green
          ...
          <div className="flex flex-col flex-1 h-full">
            <div className="flex flex-col flex-1 justify-center">
              ...
              <p className="text-lg">Upload or use existing datasets to analyse plant data in relation to weather data.</p>
            </div>
        ...
        <div className='flex flex-col bg-gradient-to-r from-medium-green
          ...
          <div className='flex flex-row gap-5 justify-start flex-1'>
            <img src={graph} alt='graph-icon' className='w-[50px] h-[45px]'/>
            <p className="text-lg pb-5">View data trends.</p>
          </div>
          <div className="flex flex-row justify-end mr-1">
              <button  className="hover:bg-white hover:text-black py-2 px-3 rounded-xl w-[150px] hover:border hover:border-solid hover:border-black
              bg-dark-bottle-green text-white">Get started</button>
        ...
        <div className='flex flex-col bg-gradient-to-r from-medium-green 
          ...
          <div className='flex flex-row gap-5 justify-start flex-1'>
            <img src={report} alt='graph-icon' className='w-[50px] h-[50px]'/>
            <p className="text-lg pb-5">Harvest final intelligence.</p>
          </div>
          <div className="flex flex-row justify-end mr-1">
              <button  className="hover:bg-white hover:text-black py-2 px-3 rounded-xl w-[150px] hover:border hover:border-solid hover:border-black
              bg-dark-bottle-green text-white">Get started</button>
